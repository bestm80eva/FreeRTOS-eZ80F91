...
#if 1	/* ZiLOG's C-Compiler can not handle the existing macros */
#define	FreeRTOS_htonl portFreeRTOS_htonl
#define FreeRTOS_htons portFreeRTOS_htons
...
#define ipconfigDHCPREGISTERHOSTNAME 1
...
#define ipconfigETHERNET_MINIMUM_PB_PACKET_BYTES 66
