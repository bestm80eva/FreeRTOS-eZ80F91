...
;
BOOT:	EQU $			;cold start
WBOOT:	EQU $ +3		;warm start
CONST:	EQU $ +6		;console status
CONIN:	EQU $ +9		;console character in
CONOUT:	EQU $ +12		;console character out
LIST:	EQU $ +15		;list character out
PUNCH:	EQU $ +18		;punch character out
READER:	EQU $ +21		;reader character out
HOME:	EQU $ +24		;move head to home position
SELDSK:	EQU $ +27		;select disk
SETTRK:	EQU $ +30		;set track number
SETSEC:	EQU $ +33		;set sector number
SETDMA:	EQU $ +36		;set dma address
READ:	EQU $ +39		;read disk
WRITE:	EQU $ +42		;write disk
LISTST:	EQU $ +45		;return list status
SECTRN:	EQU $ +48		;sector translate
